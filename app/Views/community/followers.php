            ...
            <?php foreach ($followers as $follower): ?>
                ...
                <div class="list-group-item d-flex align-items-center justify-content-between py-3 px-0 border-subtle">
                    <div class="d-flex align-items-center gap-3">
                        <?php if (!empty($follower['avatar_path'])): ?>
                            <img src="<?= e(avatar_url($follower['avatar_path'])) ?>" alt="<?= e($fName) ?>" class="avatar avatar-img rounded-circle flex-shrink-0 shadow-sm" style="width: 44px; height: 44px; object-fit: cover;">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <a href="/community/user/<?= $fId ?>" class="fw-bold text-body text-decoration-none hover-primary">
                                <?= e($fName) ?>
                            </a>
